...
class Model {
  public:
      ...
      struct Building : Multipolygon {}; // Building inherit from Multipolygon
      
      struct Leisure : Multipolygon {}; // Leisure inherit from Multipolygon
      
      struct Water : Multipolygon {}; // Water inherit from Multipolygon
      ...
      Model( const std::vector<std::byte> &xml ); // Constructor for Model class
      
      auto MetricScale() const noexcept { return m_MetricScale; } // Member function
      
      auto& Nodes() const noexcept { return m_Nodes; } // Member function
